...
METRICS|市值:X|PE:X|EPS:X|Beta:X|殖利率:X|均量:X|目標價:${sym}X|操作:X

說明：
- 市值用「兆」（如 22.5兆）、PE 如 27.4x、EPS 如 82.5元、Beta 如 0.88、殖利率如 2.1%、均量如 2.1萬張、目標價帶幣別符號
- 操作只能填三選一：買進 / 持有 / 賣出

第二行開始輸出以下三段：

【核心評語】
一句話結論，並說明操作建議（買進/持有/賣出）理由。
